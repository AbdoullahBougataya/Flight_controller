...
void offset(int16_t* accelGyro, float* rawAccelGyro) {
  ...
  rawAccelGyro[3] = (accelGyro[3] / 16384.0) * G_MPS2 + BMI160_ACC_X_OFFSET;
  rawAccelGyro[4] = (accelGyro[4] / 16384.0) * G_MPS2 + BMI160_ACC_Y_OFFSET; // Offset added
  rawAccelGyro[5] = (accelGyro[5] / 16384.0) * G_MPS2 + BMI160_ACC_Z_OFFSET;
}
